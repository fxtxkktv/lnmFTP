    ...
    <div class="row">
		...
		<div class="modal-body">
                        <div class="input-group">
                            ...
                            <input type="text" style="width:420px" class="form-control" id="name" name="name" aria-describedby="inputGroupSuccess4Status" value="{{info.get('name','')}}">
                        </div>
                </div>
		<div class="modal-body">
                        <div class="input-group">
		...
		<div class="modal-body">
                        <div class="input-group">
                            ...
                            <input type="email" style="width:420px" class="form-control" id="email" name="email" aria-describedby="inputGroupSuccess4Status" value="{{info.get('email','')}}">
                        </div>
                </div>
		<div class="modal-body">
                        <div class="input-group">
                            <span class="input-group-addon">电话: </span>
                            <input type="text" style="width:420px" class="form-control" id="phone" name="phone" aria-describedby="inputGroupSuccess4Status" value="{{info.get('phone','')}}">
                        </div>
                </div>
		<div class="modal-body">
			<div class="input-group">
